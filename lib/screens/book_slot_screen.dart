...
import 'book_slot_screen.dart'; // make sure you import your BookSlotHealthCheckUpScreen file

class BookSlotHealthCheckUpScreen extends StatefulWidget {
  const BookSlotHealthCheckUpScreen({super.key});

  @override
  State<BookSlotHealthCheckUpScreen> createState() => _BookSlotHealthCheckUpScreenState();
}

class _BookSlotHealthCheckUpScreenState extends State<BookSlotHealthCheckUpScreen> {
