...
class AdminClaimHistoryPt2 extends StatefulWidget {
  const AdminClaimHistoryPt2({super.key});

  @override
  State<AdminClaimHistoryPt2> createState() => _AdminClaimHistoryPt2State();
}

class _AdminClaimHistoryPt2State extends State<AdminClaimHistoryPt2> {
